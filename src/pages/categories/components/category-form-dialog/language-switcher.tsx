...
import type { LanguageSwitcherProps } from "./category-form-dialog.interface";
  ...
  return (
    <div className="px-6 py-4 border-b border-border">
      <div className="flex flex-col gap-2">
        <Label>{t("categories.form.languageSelector.label")}</Label>
        ...
        <p className="text-xs text-muted-foreground">
          {t("categories.form.languageSelector.editing")}: {currentLanguageLabel}
        </p>
      </div>
    </div>
  );
