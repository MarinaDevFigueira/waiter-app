...
function OrderCardHeader({ children, className, ...props }: OrderCardSubProps) {
  return (
    <div
      className={cn(
...
function OrderCardItems({ children, className, ...props }: OrderCardSubProps) {
  return (
    <div
      className={cn(
...
function OrderCardItem({ name, quantity, className, ...props }: OrderCardItemProps) {
  return (
    <div
      className={cn(
...
function OrderCardFooter({ children, className, ...props }: OrderCardSubProps) {
  return (
    <div
      className={cn(
